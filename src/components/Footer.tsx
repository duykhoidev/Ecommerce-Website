      ...
      <div className="flex flex-col md:flex-row justify-between gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          ...
          <div className="flex gap-6">
            ...
            <Image src="/pinterest.svg" alt="" width={16} height={16} />
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          ...
          <div className="flex justify-between">
            <Image src="/discover.svg" alt="" width={40} height={20} />
            <Image src="/apple-pay.svg" alt="" width={40} height={20} />
            <Image src="/paypal.svg" alt="" width={40} height={20} />
            <Image src="/mastercard.svg" alt="" width={40} height={20} />
            <Image src="/visa.svg" alt="" width={40} height={20} />
          </div>
        </div>
      </div>
      {/* BOTTOM */}
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        <div className="">&copy; 2024 Ecommerce. All rights reserved.</div>
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="">
            <span className="text-gray-500 mr-4">Language</span>
            <span className="font-medium">Vietnam | English </span>
          </div>
